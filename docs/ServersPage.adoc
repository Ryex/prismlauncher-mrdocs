...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/ServersPage.h#L55[ui&sol;pages&sol;instance&sol;ServersPage&period;h]&gt;`
