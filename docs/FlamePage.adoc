...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/flame/FlamePage.h#L57[ui&sol;pages&sol;modplatform&sol;flame&sol;FlamePage&period;h]&gt;`
