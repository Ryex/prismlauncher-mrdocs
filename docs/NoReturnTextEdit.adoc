...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/instanceview/InstanceDelegate.cpp#L341[ui&sol;instanceview&sol;InstanceDelegate&period;cpp]&gt;`
