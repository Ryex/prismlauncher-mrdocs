...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launch/steps/LookupServerAddress.h#L24[launch&sol;steps&sol;LookupServerAddress&period;h]&gt;`
