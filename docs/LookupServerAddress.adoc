...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/steps/LookupServerAddress.h#L24[launch&sol;steps&sol;LookupServerAddress&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class LookupServerAddress
...
| xref:LookupServerAddress/2constructor.adoc[`LookupServerAddress`]         [.small]#[constructor]#
| 
...
| xref:LookupServerAddress/executeTask.adoc[`executeTask`] 
| 
...
| xref:LookupServerAddress/setLookupAddress.adoc[`setLookupAddress`] 
| 

| xref:LookupServerAddress/setOutputAddressPtr.adoc[`setOutputAddressPtr`] 
| 
...
| xref:LookupServerAddress/2destructor.adoc[`&tilde;LookupServerAddress`] [.small]#[destructor]#
| 
...
| xref:LookupServerAddress/staticMetaObject.adoc[`staticMetaObject`] 
| 
