...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ResourcePackPage.h#L70[ui&sol;pages&sol;instance&sol;ResourcePackPage&period;h]&gt;`
