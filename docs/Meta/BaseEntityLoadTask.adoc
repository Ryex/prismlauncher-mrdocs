...
= xref:Meta.adoc[Meta]::BaseEntityLoadTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/meta/BaseEntity.h#L57[meta&sol;BaseEntity&period;h]&gt;`
...
| xref:Meta/BaseEntityLoadTask/2constructor.adoc[`BaseEntityLoadTask`]         [.small]#[constructor]#
| 
...
| xref:Meta/BaseEntityLoadTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:Meta/BaseEntityLoadTask/2destructor.adoc[`&tilde;BaseEntityLoadTask`] [.small]#[destructor]#
| 
...
| xref:Meta/BaseEntityLoadTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
