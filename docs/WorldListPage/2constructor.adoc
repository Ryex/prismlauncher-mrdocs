...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/WorldListPage.h#L56[ui&sol;pages&sol;instance&sol;WorldListPage&period;h]&gt;`
