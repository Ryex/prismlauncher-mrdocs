...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/InstallLoaderDialog.cpp#L36[ui&sol;dialogs&sol;InstallLoaderDialog&period;cpp]&gt;`
