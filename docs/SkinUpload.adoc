...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/skins/SkinUpload.h#L23[minecraft&sol;skins&sol;SkinUpload&period;h]&gt;`
...
| xref:SkinUpload/2constructor.adoc[`SkinUpload`]         [.small]#[constructor]#
| 
...
| xref:SkinUpload/2destructor.adoc[`&tilde;SkinUpload`] [.small]#[destructor]#
| 
...
| xref:SkinUpload/make.adoc[`make`] 
| 
...
| xref:SkinUpload/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:SkinUpload/getReply.adoc[`getReply`] 
| 
