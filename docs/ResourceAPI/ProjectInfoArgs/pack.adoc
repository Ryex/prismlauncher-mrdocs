[#ResourceAPI-ProjectInfoArgs-pack]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/ResourceAPI.h#L107[modplatform&sol;ResourceAPI&period;h]&gt;`
