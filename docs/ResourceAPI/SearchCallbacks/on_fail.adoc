[#ResourceAPI-SearchCallbacks-on_fail]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/ResourceAPI.h#L83[modplatform&sol;ResourceAPI&period;h]&gt;`
