[#ResourceAPI-SearchCallbacks-on_succeed]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/ResourceAPI.h#L82[modplatform&sol;ResourceAPI&period;h]&gt;`
