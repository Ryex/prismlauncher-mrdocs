...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ResourcePage.h#L32[ui&sol;pages&sol;modplatform&sol;ResourcePage&period;h]&gt;`
