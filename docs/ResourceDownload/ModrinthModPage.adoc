...
= xref:ResourceDownload.adoc[ResourceDownload]::ModrinthModPage
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/modrinth/ModrinthResourcePages.h#L75[ui&sol;pages&sol;modplatform&sol;modrinth&sol;ModrinthResourcePages&period;h]&gt;`
...
| xref:ResourceDownload/ModrinthModPage/2constructor.adoc[`ModrinthModPage`]         [.small]#[constructor]#
| 
...
| xref:ResourceDownload/ModrinthModPage/2destructor.adoc[`&tilde;ModrinthModPage`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ModrinthModPage/staticMetaObject.adoc[`staticMetaObject`] 
| 
