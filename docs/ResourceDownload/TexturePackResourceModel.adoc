...
= xref:ResourceDownload.adoc[ResourceDownload]::TexturePackResourceModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/TexturePackModel.h#L12[ui&sol;pages&sol;modplatform&sol;TexturePackModel&period;h]&gt;`
...
| xref:ResourceDownload/TexturePackResourceModel/2constructor.adoc[`TexturePackResourceModel`]         [.small]#[constructor]#
| 
