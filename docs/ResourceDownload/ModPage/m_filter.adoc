...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ModPage.h#L70[ui&sol;pages&sol;modplatform&sol;ModPage&period;h]&gt;`
