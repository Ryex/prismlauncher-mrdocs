[#ResourceDownload-ModrinthModModel]
= xref:ResourceDownload.adoc[ResourceDownload]::ModrinthModModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/modrinth/ModrinthResourceModels.h#L29[ui&sol;pages&sol;modplatform&sol;modrinth&sol;ModrinthResourceModels&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ModrinthModModel
...
| xref:ResourceDownload/ModrinthModModel/2constructor.adoc[`ModrinthModModel`]         [.small]#[constructor]#
| 
...
| xref:ResourceDownload/ModrinthModModel/2destructor.adoc[`&tilde;ModrinthModModel`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ModrinthModModel/staticMetaObject.adoc[`staticMetaObject`] 
| 
