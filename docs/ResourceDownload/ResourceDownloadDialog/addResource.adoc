...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/ResourceDownloadDialog.h#L66[ui&sol;dialogs&sol;ResourceDownloadDialog&period;h]&gt;`
