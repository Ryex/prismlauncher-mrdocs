...
= xref:ResourceDownload.adoc[ResourceDownload]::ResourcePage
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ResourcePage.h#L29[ui&sol;pages&sol;modplatform&sol;ResourcePage&period;h]&gt;`
...
| xref:ResourceDownload/ResourcePage/2destructor.adoc[`&tilde;ResourcePage`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ResourcePage/2constructor.adoc[`ResourcePage`]         [.small]#[constructor]#
| 
