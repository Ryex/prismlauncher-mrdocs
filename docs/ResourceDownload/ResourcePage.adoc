...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ResourcePage.h#L29[ui&sol;pages&sol;modplatform&sol;ResourcePage&period;h]&gt;`
