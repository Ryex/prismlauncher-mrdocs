...
= xref:ResourceDownload.adoc[ResourceDownload]::ResourcePackDownloadDialog
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/dialogs/ResourceDownloadDialog.h#L116[ui&sol;dialogs&sol;ResourceDownloadDialog&period;h]&gt;`
...
| xref:ResourceDownload/ResourcePackDownloadDialog/2constructor.adoc[`ResourcePackDownloadDialog`]         [.small]#[constructor]#
| 
...
| 
| xref:ResourceDownload/ResourcePackDownloadDialog/geometrySaveKey.adoc[`geometrySaveKey`] 
| 
...
| xref:ResourceDownload/ResourcePackDownloadDialog/2destructor.adoc[`&tilde;ResourcePackDownloadDialog`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ResourcePackDownloadDialog/staticMetaObject.adoc[`staticMetaObject`] 
| 
