...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ShaderPackModel.h#L19[ui&sol;pages&sol;modplatform&sol;ShaderPackModel&period;h]&gt;`
