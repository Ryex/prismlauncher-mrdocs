[#ResourceDownload-ModModel-loadIndexedPack]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ModModel.h#L32[ui&sol;pages&sol;modplatform&sol;ModModel&period;h]&gt;`
