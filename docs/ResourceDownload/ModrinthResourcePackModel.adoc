[#ResourceDownload-ModrinthResourcePackModel]
= xref:ResourceDownload.adoc[ResourceDownload]::ModrinthResourcePackModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/modrinth/ModrinthResourceModels.h#L48[ui&sol;pages&sol;modplatform&sol;modrinth&sol;ModrinthResourceModels&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ModrinthResourcePackModel
...
| xref:ResourceDownload/ModrinthResourcePackModel/2constructor.adoc[`ModrinthResourcePackModel`]         [.small]#[constructor]#
| 
...
| xref:ResourceDownload/ModrinthResourcePackModel/2destructor.adoc[`&tilde;ModrinthResourcePackModel`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ModrinthResourcePackModel/staticMetaObject.adoc[`staticMetaObject`] 
| 
