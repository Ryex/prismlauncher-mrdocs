...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ResourcePackPage.h#L46[ui&sol;pages&sol;modplatform&sol;ResourcePackPage&period;h]&gt;`
