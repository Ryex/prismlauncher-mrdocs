...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ResourcePackModel.h#L35[ui&sol;pages&sol;modplatform&sol;ResourcePackModel&period;h]&gt;`
