...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ResourcePackModel.h#L29[ui&sol;pages&sol;modplatform&sol;ResourcePackModel&period;h]&gt;`
