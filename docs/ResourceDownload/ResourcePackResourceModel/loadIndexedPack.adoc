...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ResourcePackModel.h#L28[ui&sol;pages&sol;modplatform&sol;ResourcePackModel&period;h]&gt;`
