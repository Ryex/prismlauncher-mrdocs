[#ResourceDownload-ModrinthTexturePackModel]
= xref:ResourceDownload.adoc[ResourceDownload]::ModrinthTexturePackModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/modrinth/ModrinthResourceModels.h#L66[ui&sol;pages&sol;modplatform&sol;modrinth&sol;ModrinthResourceModels&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ModrinthTexturePackModel
...
| xref:ResourceDownload/ModrinthTexturePackModel/2constructor.adoc[`ModrinthTexturePackModel`]         [.small]#[constructor]#
| 
...
| xref:ResourceDownload/ModrinthTexturePackModel/2destructor.adoc[`&tilde;ModrinthTexturePackModel`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ModrinthTexturePackModel/staticMetaObject.adoc[`staticMetaObject`] 
| 
