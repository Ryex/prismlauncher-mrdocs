...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ResourceModel.h#L61[ui&sol;pages&sol;modplatform&sol;ResourceModel&period;h]&gt;`
