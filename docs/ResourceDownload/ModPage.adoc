...
= xref:ResourceDownload.adoc[ResourceDownload]::ModPage
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ModPage.h#L24[ui&sol;pages&sol;modplatform&sol;ModPage&period;h]&gt;`
...
| xref:ResourceDownload/ModPage/2constructor.adoc[`ModPage`]         [.small]#[constructor]#
| 
