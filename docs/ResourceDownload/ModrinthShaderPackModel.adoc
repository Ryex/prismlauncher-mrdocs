[#ResourceDownload-ModrinthShaderPackModel]
= xref:ResourceDownload.adoc[ResourceDownload]::ModrinthShaderPackModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/modrinth/ModrinthResourceModels.h#L84[ui&sol;pages&sol;modplatform&sol;modrinth&sol;ModrinthResourceModels&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ModrinthShaderPackModel
    : public xref:ResourceDownload/ShaderPackResourceModel.adoc[ShaderPackResourceModel];
----
...
| xref:ResourceDownload/ModrinthShaderPackModel/2constructor.adoc[`ModrinthShaderPackModel`]         [.small]#[constructor]#
| 
...
| xref:ResourceDownload/ShaderPackResourceModel/loadExtraPackInfo.adoc[`loadExtraPackInfo`] 
| 

| xref:ResourceDownload/ShaderPackResourceModel/loadIndexedPack.adoc[`loadIndexedPack`] 
| 

| xref:ResourceDownload/ShaderPackResourceModel/loadIndexedPackVersions.adoc[`loadIndexedPackVersions`] 
| 
...
| xref:ResourceDownload/ShaderPackResourceModel/searchWithTerm.adoc[`searchWithTerm`] 
| 
...
| xref:ResourceDownload/ModrinthShaderPackModel/2destructor.adoc[`&tilde;ModrinthShaderPackModel`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/ShaderPackResourceModel/staticMetaObject.adoc[`staticMetaObject`] 
| 

| xref:ResourceDownload/ModrinthShaderPackModel/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:ResourceDownload/ShaderPackResourceModel/m_base_instance.adoc[`m&lowbar;base&lowbar;instance`] 
| 
