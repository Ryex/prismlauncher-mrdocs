...
= xref:ResourceDownload.adoc[ResourceDownload]::ModModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ModModel.h#L23[ui&sol;pages&sol;modplatform&sol;ModModel&period;h]&gt;`
...
| xref:ResourceDownload/ModModel/2constructor.adoc[`ModModel`]         [.small]#[constructor]#
| 
