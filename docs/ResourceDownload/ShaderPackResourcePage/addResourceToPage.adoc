...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/ShaderPackPage.h#L41[ui&sol;pages&sol;modplatform&sol;ShaderPackPage&period;h]&gt;`
