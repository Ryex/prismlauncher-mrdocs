[#ResourceDownload-FlameShaderPackModel]
= xref:ResourceDownload.adoc[ResourceDownload]::FlameShaderPackModel
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/flame/FlameResourceModels.h#L77[ui&sol;pages&sol;modplatform&sol;flame&sol;FlameResourceModels&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class FlameShaderPackModel
...
| xref:ResourceDownload/FlameShaderPackModel/2constructor.adoc[`FlameShaderPackModel`]         [.small]#[constructor]#
| 
...
| xref:ResourceDownload/FlameShaderPackModel/2destructor.adoc[`&tilde;FlameShaderPackModel`] [.small]#[destructor]#
| 
...
| xref:ResourceDownload/FlameShaderPackModel/staticMetaObject.adoc[`staticMetaObject`] 
| 
