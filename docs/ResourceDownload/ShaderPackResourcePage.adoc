...
= xref:ResourceDownload.adoc[ResourceDownload]::ShaderPackResourcePage
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ShaderPackPage.h#L18[ui&sol;pages&sol;modplatform&sol;ShaderPackPage&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ShaderPackResourcePage
...
| xref:ResourceDownload/ShaderPackResourcePage/2constructor.adoc[`ShaderPackResourcePage`]         [.small]#[constructor]#
| 
