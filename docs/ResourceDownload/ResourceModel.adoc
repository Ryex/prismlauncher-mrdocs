...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/ResourceModel.h#L28[ui&sol;pages&sol;modplatform&sol;ResourceModel&period;h]&gt;`
