...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/TexturePackModel.h#L16[ui&sol;pages&sol;modplatform&sol;TexturePackModel&period;h]&gt;`
