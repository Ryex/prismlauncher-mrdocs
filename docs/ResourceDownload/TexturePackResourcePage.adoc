...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/TexturePackPage.h#L20[ui&sol;pages&sol;modplatform&sol;TexturePackPage&period;h]&gt;`
