...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/update/FMLLibrariesTask.h#L8[minecraft&sol;update&sol;FMLLibrariesTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class FMLLibrariesTask
...
| xref:FMLLibrariesTask/2constructor.adoc[`FMLLibrariesTask`]         [.small]#[constructor]#
| 
...
| xref:FMLLibrariesTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:FMLLibrariesTask/2destructor.adoc[`&tilde;FMLLibrariesTask`] [.small]#[destructor]#
| 
...
| xref:FMLLibrariesTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
