...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/update/FMLLibrariesTask.h#L8[minecraft&sol;update&sol;FMLLibrariesTask&period;h]&gt;`
