...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/modrinth/ModrinthInstanceCreationTask.h#L9[modplatform&sol;modrinth&sol;ModrinthInstanceCreationTask&period;h]&gt;`
