...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/flame/FlameModIndex.h#L16[modplatform&sol;flame&sol;FlameModIndex&period;h]&gt;`
