...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/tasks/LocalDataPackParseTask.h#L47[minecraft&sol;mod&sol;tasks&sol;LocalDataPackParseTask&period;h]&gt;`
