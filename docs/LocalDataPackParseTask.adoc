...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/mod/tasks/LocalDataPackParseTask.h#L47[minecraft&sol;mod&sol;tasks&sol;LocalDataPackParseTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class LocalDataPackParseTask
...
| xref:LocalDataPackParseTask/2constructor.adoc[`LocalDataPackParseTask`]         [.small]#[constructor]#
| 
...
| xref:LocalDataPackParseTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:LocalDataPackParseTask/token.adoc[`token`] 
| 
...
| xref:LocalDataPackParseTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
