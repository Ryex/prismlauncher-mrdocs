...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/GameOptionsPage.h#L51[ui&sol;pages&sol;instance&sol;GameOptionsPage&period;h]&gt;`
