...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/steps/CheckJava.h#L22[launch&sol;steps&sol;CheckJava&period;h]&gt;`
...
| xref:CheckJava/2constructor.adoc[`CheckJava`]         [.small]#[constructor]#
| 
...
| xref:CheckJava/executeTask.adoc[`executeTask`] 
| 
...
| xref:CheckJava/2destructor.adoc[`&tilde;CheckJava`] [.small]#[destructor]#
| 
...
| xref:CheckJava/staticMetaObject.adoc[`staticMetaObject`] 
| 
