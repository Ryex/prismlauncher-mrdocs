...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/InstallLoaderDialog.h#L29[ui&sol;dialogs&sol;InstallLoaderDialog&period;h]&gt;`
