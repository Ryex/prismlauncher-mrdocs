...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/auth/steps/XboxProfileStep.h#L9[minecraft&sol;auth&sol;steps&sol;XboxProfileStep&period;h]&gt;`
