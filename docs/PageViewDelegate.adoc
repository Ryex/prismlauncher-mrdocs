...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/PageContainer_p.h#L26[ui&sol;widgets&sol;PageContainer&lowbar;p&period;h]&gt;`
