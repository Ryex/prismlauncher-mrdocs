...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/InstanceCreationTask.h#L6[InstanceCreationTask&period;h]&gt;`
...
| xref:InstanceCreationTask/2constructor.adoc[`InstanceCreationTask`]         [.small]#[constructor]#
| 
...
| xref:InstanceCreationTask/2destructor.adoc[`&tilde;InstanceCreationTask`] [.small]#[destructor]#
| 
