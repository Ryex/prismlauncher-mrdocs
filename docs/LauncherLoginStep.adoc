...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/auth/steps/LauncherLoginStep.h#L9[minecraft&sol;auth&sol;steps&sol;LauncherLoginStep&period;h]&gt;`
