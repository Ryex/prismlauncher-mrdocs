...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/ModMinecraftJar.h#L21[minecraft&sol;launch&sol;ModMinecraftJar&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ModMinecraftJar
...
| xref:ModMinecraftJar/2constructor.adoc[`ModMinecraftJar`]         [.small]#[constructor]#
| 
...
| xref:ModMinecraftJar/executeTask.adoc[`executeTask`] 
| 
...
| xref:ModMinecraftJar/2destructor.adoc[`&tilde;ModMinecraftJar`] [.small]#[destructor]#
| 
...
| xref:ModMinecraftJar/staticMetaObject.adoc[`staticMetaObject`] 
| 
