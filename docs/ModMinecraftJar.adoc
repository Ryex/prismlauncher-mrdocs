...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/ModMinecraftJar.h#L21[minecraft&sol;launch&sol;ModMinecraftJar&period;h]&gt;`
