...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/helpers/ExportToModList.h#L27[modplatform&sol;helpers&sol;ExportToModList&period;h]&gt;`
