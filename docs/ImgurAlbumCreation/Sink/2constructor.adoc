...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/screenshots/ImgurAlbumCreation.h#L52[screenshots&sol;ImgurAlbumCreation&period;h]&gt;`
