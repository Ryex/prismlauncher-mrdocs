...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/screenshots/ImgurAlbumCreation.h#L59[screenshots&sol;ImgurAlbumCreation&period;h]&gt;`
