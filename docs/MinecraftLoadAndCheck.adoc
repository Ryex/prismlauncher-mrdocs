...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/MinecraftLoadAndCheck.h#L23[minecraft&sol;MinecraftLoadAndCheck&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class MinecraftLoadAndCheck
...
| xref:MinecraftLoadAndCheck/2constructor.adoc[`MinecraftLoadAndCheck`]         [.small]#[constructor]#
| 
...
| xref:MinecraftLoadAndCheck/executeTask.adoc[`executeTask`] 
| 
...
| xref:MinecraftLoadAndCheck/2destructor.adoc[`&tilde;MinecraftLoadAndCheck`] [.small]#[destructor]#
| 
...
| xref:MinecraftLoadAndCheck/staticMetaObject.adoc[`staticMetaObject`] 
| 
