...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/MinecraftLoadAndCheck.h#L23[minecraft&sol;MinecraftLoadAndCheck&period;h]&gt;`
