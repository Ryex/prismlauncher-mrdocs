...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/instanceview/InstanceDelegate.h#L30[ui&sol;instanceview&sol;InstanceDelegate&period;h]&gt;`
