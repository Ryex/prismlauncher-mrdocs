...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/global/ExternalToolsPage.h#L47[ui&sol;pages&sol;global&sol;ExternalToolsPage&period;h]&gt;`
...
| xref:ExternalToolsPage/2constructor.adoc[`ExternalToolsPage`]         [.small]#[constructor]#
| 
...
| 
| xref:ExternalToolsPage/metaObject.adoc[`metaObject`] 
| 
...
| xref:ExternalToolsPage/qt_metacall.adoc[`qt&lowbar;metacall`] 
| 

| xref:ExternalToolsPage/qt_metacast.adoc[`qt&lowbar;metacast`] 
| 
...
| xref:ExternalToolsPage/2destructor.adoc[`&tilde;ExternalToolsPage`] [.small]#[destructor]#
| 
...
| xref:ExternalToolsPage/tr.adoc[`tr`] 
| 
...
| xref:ExternalToolsPage/staticMetaObject.adoc[`staticMetaObject`] 
| 
