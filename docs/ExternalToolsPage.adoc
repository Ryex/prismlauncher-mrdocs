...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/global/ExternalToolsPage.h#L47[ui&sol;pages&sol;global&sol;ExternalToolsPage&period;h]&gt;`
