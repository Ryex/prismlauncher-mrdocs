...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/tasks/LocalResourceParse.cpp#L33[minecraft&sol;mod&sol;tasks&sol;LocalResourceParse&period;cpp]&gt;`
