...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/ReconstructAssets.h#L21[minecraft&sol;launch&sol;ReconstructAssets&period;h]&gt;`
