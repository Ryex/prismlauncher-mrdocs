[#CheckUpdateTask-m_resource_model]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/CheckUpdateTask.h#L76[modplatform&sol;CheckUpdateTask&period;h]&gt;`
