...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/LaunchStep.h#L24[launch&sol;LaunchStep&period;h]&gt;`
...
| xref:LaunchStep/2constructor.adoc[`LaunchStep`]         [.small]#[constructor]#
| 
...
| xref:LaunchStep/2destructor.adoc[`&tilde;LaunchStep`] [.small]#[destructor]#
| 
