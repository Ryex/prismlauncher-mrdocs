[#BaseProfilerFactory-createProfiler]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/tools/BaseProfiler.h#L33[tools&sol;BaseProfiler&period;h]&gt;`
