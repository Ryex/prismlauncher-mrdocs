...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/mod/tasks/ResourceFolderLoadTask.h#L47[minecraft&sol;mod&sol;tasks&sol;ResourceFolderLoadTask&period;h]&gt;`
...
| xref:ResourceFolderLoadTask/Result.adoc[`Result`] 
| 
...
| xref:ResourceFolderLoadTask/2constructor.adoc[`ResourceFolderLoadTask`]         [.small]#[constructor]#
| 
...
| xref:ResourceFolderLoadTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:ResourceFolderLoadTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
