...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/auth/steps/MSAStep.h#L42[minecraft&sol;auth&sol;steps&sol;MSAStep&period;h]&gt;`
