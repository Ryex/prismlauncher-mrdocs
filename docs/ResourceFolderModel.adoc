...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/mod/ResourceFolderModel.h#L61[minecraft&sol;mod&sol;ResourceFolderModel&period;h]&gt;`
...
| xref:ResourceFolderModel/2constructor.adoc[`ResourceFolderModel`]         [.small]#[constructor]#
| 
...
| xref:ResourceFolderModel/2destructor.adoc[`&tilde;ResourceFolderModel`] [.small]#[destructor]#
| 
...
This model manages a list of resources&period; As such, external users of such resources do not own them,
and the resource&apos;s lifetime is contingent on the model&apos;s lifetime&period;

TODO&colon; Make the resources unique pointers accessible through weak pointers&period;
