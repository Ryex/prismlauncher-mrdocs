...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ServerPingTask.h#L9[ui&sol;pages&sol;instance&sol;ServerPingTask&period;h]&gt;`
