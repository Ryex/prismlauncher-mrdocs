...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/ClaimAccount.h#L21[minecraft&sol;launch&sol;ClaimAccount&period;h]&gt;`
...
| xref:ClaimAccount/2constructor.adoc[`ClaimAccount`]         [.small]#[constructor]#
| 
...
| xref:ClaimAccount/executeTask.adoc[`executeTask`] 
| 
...
| xref:ClaimAccount/2destructor.adoc[`&tilde;ClaimAccount`] [.small]#[destructor]#
| 
...
| xref:ClaimAccount/staticMetaObject.adoc[`staticMetaObject`] 
| 
