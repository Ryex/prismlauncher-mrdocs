...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/ClaimAccount.h#L21[minecraft&sol;launch&sol;ClaimAccount&period;h]&gt;`
