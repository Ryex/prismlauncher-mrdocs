[#EnsureMetadataTask-2constructor-0d]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/EnsureMetadataTask.h#L18[modplatform&sol;EnsureMetadataTask&period;h]&gt;`
