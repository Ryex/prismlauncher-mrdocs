...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/mod/tasks/LocalResourceUpdateTask.h#L26[minecraft&sol;mod&sol;tasks&sol;LocalResourceUpdateTask&period;h]&gt;`
