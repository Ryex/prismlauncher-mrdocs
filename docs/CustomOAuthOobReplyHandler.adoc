...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/auth/steps/MSAStep.cpp#L70[minecraft&sol;auth&sol;steps&sol;MSAStep&period;cpp]&gt;`
