...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/LaunchController.h#L45[LaunchController&period;h]&gt;`
...
| xref:LaunchController/2constructor.adoc[`LaunchController`]         [.small]#[constructor]#
| 
...
| xref:LaunchController/executeTask.adoc[`executeTask`] 
| 
...
| xref:LaunchController/id.adoc[`id`] 
| 

| xref:LaunchController/instance.adoc[`instance`] 
| 
...
| xref:LaunchController/setAccountToUse.adoc[`setAccountToUse`] 
| 

| xref:LaunchController/setDemo.adoc[`setDemo`] 
| 

| xref:Task/setDetails.adoc[`setDetails`] 
| 

| xref:LaunchController/setInstance.adoc[`setInstance`] 
| 

| xref:LaunchController/setOfflineName.adoc[`setOfflineName`] 
| 

| xref:LaunchController/setOnline.adoc[`setOnline`] 
| 

| xref:LaunchController/setParentWidget.adoc[`setParentWidget`] 
| 

| xref:LaunchController/setProfiler.adoc[`setProfiler`] 
| 
...
| xref:LaunchController/setTargetToJoin.adoc[`setTargetToJoin`] 
| 
...
| xref:LaunchController/2destructor.adoc[`&tilde;LaunchController`] [.small]#[destructor]#
| 
...
| xref:LaunchController/staticMetaObject.adoc[`staticMetaObject`] 
| 
