...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/tasks/Task.h#L89[tasks&sol;Task&period;h]&gt;`
...
| xref:Task/2constructor.adoc[`Task`]         [.small]#[constructor]#
| 
...
| xref:Task/2destructor.adoc[`&tilde;Task`] [.small]#[destructor]#
| 
