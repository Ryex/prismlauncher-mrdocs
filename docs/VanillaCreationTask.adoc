...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/VanillaInstanceCreationTask.h#L7[minecraft&sol;VanillaInstanceCreationTask&period;h]&gt;`
