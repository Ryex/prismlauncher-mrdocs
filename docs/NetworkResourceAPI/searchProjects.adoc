...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/helpers/NetworkResourceAPI.h#L12[modplatform&sol;helpers&sol;NetworkResourceAPI&period;h]&gt;`
