...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ScreenshotsPage.cpp#L219[ui&sol;pages&sol;instance&sol;ScreenshotsPage&period;cpp]&gt;`
