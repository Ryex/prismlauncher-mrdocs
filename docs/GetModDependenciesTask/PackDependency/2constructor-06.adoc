...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/tasks/GetModDependenciesTask.h#L45[minecraft&sol;mod&sol;tasks&sol;GetModDependenciesTask&period;h]&gt;`
