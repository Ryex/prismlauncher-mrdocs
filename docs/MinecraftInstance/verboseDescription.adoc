[#MinecraftInstance-verboseDescription]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/MinecraftInstance.h#L127[minecraft&sol;MinecraftInstance&period;h]&gt;`
