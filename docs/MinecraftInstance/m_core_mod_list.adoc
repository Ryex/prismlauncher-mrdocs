[#MinecraftInstance-m_core_mod_list]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/MinecraftInstance.h#L169[minecraft&sol;MinecraftInstance&period;h]&gt;`
