[#MinecraftInstance-m_loader_mod_list]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/MinecraftInstance.h#L168[minecraft&sol;MinecraftInstance&period;h]&gt;`
