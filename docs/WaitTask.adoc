...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/skins/SkinManageDialog.cpp#L388[ui&sol;dialogs&sol;skins&sol;SkinManageDialog&period;cpp]&gt;`
