...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/auth/steps/EntitlementsStep.h#L9[minecraft&sol;auth&sol;steps&sol;EntitlementsStep&period;h]&gt;`
