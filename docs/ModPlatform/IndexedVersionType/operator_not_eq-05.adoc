[#ModPlatform-IndexedVersionType-operator_not_eq-05]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/ModIndex.h#L73[modplatform&sol;ModIndex&period;h]&gt;`
