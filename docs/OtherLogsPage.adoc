...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/OtherLogsPage.h#L50[ui&sol;pages&sol;instance&sol;OtherLogsPage&period;h]&gt;`
...
| xref:OtherLogsPage/2constructor.adoc[`OtherLogsPage`]         [.small]#[constructor]#
| 
...
| 
| xref:OtherLogsPage/metaObject.adoc[`metaObject`] 
| 
...
| 
| xref:OtherLogsPage/qt_metacall.adoc[`qt&lowbar;metacall`] 
| 

| xref:OtherLogsPage/qt_metacast.adoc[`qt&lowbar;metacast`] 
| 
...
| xref:OtherLogsPage/2destructor.adoc[`&tilde;OtherLogsPage`] [.small]#[destructor]#
| 
...
| xref:OtherLogsPage/staticMetaObject.adoc[`staticMetaObject`] 
| 
