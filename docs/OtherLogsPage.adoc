...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/OtherLogsPage.h#L50[ui&sol;pages&sol;instance&sol;OtherLogsPage&period;h]&gt;`
