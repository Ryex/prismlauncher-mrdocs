...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/CreateGameFolders.h#L23[minecraft&sol;launch&sol;CreateGameFolders&period;h]&gt;`
...
| xref:CreateGameFolders/2constructor.adoc[`CreateGameFolders`]         [.small]#[constructor]#
| 
...
| xref:CreateGameFolders/executeTask.adoc[`executeTask`] 
| 
...
| xref:CreateGameFolders/2destructor.adoc[`&tilde;CreateGameFolders`] [.small]#[destructor]#
| 
...
| xref:CreateGameFolders/staticMetaObject.adoc[`staticMetaObject`] 
| 
