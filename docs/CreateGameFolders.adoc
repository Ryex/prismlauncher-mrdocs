...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/CreateGameFolders.h#L23[minecraft&sol;launch&sol;CreateGameFolders&period;h]&gt;`
