...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/net/Upload.h#L44[net&sol;Upload&period;h]&gt;`
...
| xref:Net/Upload/2constructor.adoc[`Upload`]         [.small]#[constructor]#
| 
...
| xref:Net/Upload/makeByteArray.adoc[`makeByteArray`] 
| 
...
| xref:Net/Upload/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:Net/Upload/getReply.adoc[`getReply`] 
| 
...
| xref:Net/Upload/m_post_data.adoc[`m&lowbar;post&lowbar;data`] 
| 
