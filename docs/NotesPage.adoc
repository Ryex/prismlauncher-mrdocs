...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/NotesPage.h#L48[ui&sol;pages&sol;instance&sol;NotesPage&period;h]&gt;`
