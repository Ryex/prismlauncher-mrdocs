...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/CheckUpdateTask.h#L12[modplatform&sol;CheckUpdateTask&period;h]&gt;`
...
| xref:CheckUpdateTask/2constructor.adoc[`CheckUpdateTask`]         [.small]#[constructor]#
| 
