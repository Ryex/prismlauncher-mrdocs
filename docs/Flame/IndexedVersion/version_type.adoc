...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/flame/FlamePackIndex.h#L20[modplatform&sol;flame&sol;FlamePackIndex&period;h]&gt;`
