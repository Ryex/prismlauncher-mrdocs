...
= xref:Flame.adoc[Flame]::FileResolvingTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/flame/FileResolvingTask.h#L24[modplatform&sol;flame&sol;FileResolvingTask&period;h]&gt;`
...
| xref:Flame/FileResolvingTask/2constructor.adoc[`FileResolvingTask`]         [.small]#[constructor]#
| 
...
| xref:Flame/FileResolvingTask/getResults.adoc[`getResults`] 
| 
...
| xref:Flame/FileResolvingTask/2destructor.adoc[`&tilde;FileResolvingTask`] [.small]#[destructor]#
| 
...
| xref:Flame/FileResolvingTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:Flame/FileResolvingTask/netJobFinished.adoc[`netJobFinished`] 
| 
