...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/flame/FileResolvingTask.h#L24[modplatform&sol;flame&sol;FileResolvingTask&period;h]&gt;`
