...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/ScanModFolders.h#L21[minecraft&sol;launch&sol;ScanModFolders&period;h]&gt;`
