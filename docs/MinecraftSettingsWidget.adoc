...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/MinecraftSettingsWidget.h#L47[ui&sol;widgets&sol;MinecraftSettingsWidget&period;h]&gt;`
