...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/technic/TechnicPage.h#L57[ui&sol;pages&sol;modplatform&sol;technic&sol;TechnicPage&period;h]&gt;`
