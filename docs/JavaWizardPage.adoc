...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/setupwizard/JavaWizardPage.h#L7[ui&sol;setupwizard&sol;JavaWizardPage&period;h]&gt;`
