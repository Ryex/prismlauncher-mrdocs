...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/flame/FlameInstanceCreationTask.h#L50[modplatform&sol;flame&sol;FlameInstanceCreationTask&period;h]&gt;`
