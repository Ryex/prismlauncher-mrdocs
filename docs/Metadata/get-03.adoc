...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/MetadataHandler.h#L63[minecraft&sol;mod&sol;MetadataHandler&period;h]&gt;`
