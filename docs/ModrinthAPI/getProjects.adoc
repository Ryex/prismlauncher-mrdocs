...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/modrinth/ModrinthAPI.h#L31[modplatform&sol;modrinth&sol;ModrinthAPI&period;h]&gt;`
