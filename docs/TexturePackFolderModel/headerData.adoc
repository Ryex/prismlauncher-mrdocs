[#TexturePackFolderModel-headerData]
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/TexturePackFolderModel.h#L55[minecraft&sol;mod&sol;TexturePackFolderModel&period;h]&gt;`
