...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/InstanceSettingsPage.h#L44[ui&sol;pages&sol;instance&sol;InstanceSettingsPage&period;h]&gt;`
