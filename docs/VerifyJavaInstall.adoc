...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/VerifyJavaInstall.h#L41[minecraft&sol;launch&sol;VerifyJavaInstall&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class VerifyJavaInstall
...
| xref:VerifyJavaInstall/2constructor.adoc[`VerifyJavaInstall`]         [.small]#[constructor]#
| 
...
| xref:VerifyJavaInstall/executeTask.adoc[`executeTask`] 
| 
...
| xref:VerifyJavaInstall/2destructor.adoc[`&tilde;VerifyJavaInstall`] [.small]#[destructor]#
| 
...
| xref:VerifyJavaInstall/staticMetaObject.adoc[`staticMetaObject`] 
| 
