...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/VerifyJavaInstall.h#L41[minecraft&sol;launch&sol;VerifyJavaInstall&period;h]&gt;`
