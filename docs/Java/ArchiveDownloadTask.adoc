...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/java/download/ArchiveDownloadTask.h#L25[java&sol;download&sol;ArchiveDownloadTask&period;h]&gt;`
