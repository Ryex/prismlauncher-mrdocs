...
= xref:Java.adoc[Java]::ArchiveDownloadTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/java/download/ArchiveDownloadTask.h#L25[java&sol;download&sol;ArchiveDownloadTask&period;h]&gt;`
...
| xref:Java/ArchiveDownloadTask/2constructor.adoc[`ArchiveDownloadTask`]         [.small]#[constructor]#
| 
...
| xref:Java/ArchiveDownloadTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:Java/ArchiveDownloadTask/2destructor.adoc[`&tilde;ArchiveDownloadTask`] [.small]#[destructor]#
| 
...
| xref:Java/ArchiveDownloadTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:Java/ArchiveDownloadTask/m_checksum_hash.adoc[`m&lowbar;checksum&lowbar;hash`] 
| 

| xref:Java/ArchiveDownloadTask/m_checksum_type.adoc[`m&lowbar;checksum&lowbar;type`] 
| 
...
| xref:Java/ArchiveDownloadTask/m_final_path.adoc[`m&lowbar;final&lowbar;path`] 
| 
...
| xref:Java/ArchiveDownloadTask/m_task.adoc[`m&lowbar;task`] 
| 

| xref:Java/ArchiveDownloadTask/m_url.adoc[`m&lowbar;url`] 
| 
