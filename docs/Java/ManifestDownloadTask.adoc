...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/java/download/ManifestDownloadTask.h#L26[java&sol;download&sol;ManifestDownloadTask&period;h]&gt;`
