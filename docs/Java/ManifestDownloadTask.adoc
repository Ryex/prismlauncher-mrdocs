...
= xref:Java.adoc[Java]::ManifestDownloadTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/java/download/ManifestDownloadTask.h#L26[java&sol;download&sol;ManifestDownloadTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ManifestDownloadTask
...
| xref:Java/ManifestDownloadTask/2constructor.adoc[`ManifestDownloadTask`]         [.small]#[constructor]#
| 
...
| xref:Java/ManifestDownloadTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:Java/ManifestDownloadTask/2destructor.adoc[`&tilde;ManifestDownloadTask`] [.small]#[destructor]#
| 
...
| xref:Java/ManifestDownloadTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:Java/ManifestDownloadTask/m_checksum_hash.adoc[`m&lowbar;checksum&lowbar;hash`] 
| 

| xref:Java/ManifestDownloadTask/m_checksum_type.adoc[`m&lowbar;checksum&lowbar;type`] 
| 
...
| xref:Java/ManifestDownloadTask/m_final_path.adoc[`m&lowbar;final&lowbar;path`] 
| 
...
| xref:Java/ManifestDownloadTask/m_task.adoc[`m&lowbar;task`] 
| 

| xref:Java/ManifestDownloadTask/m_url.adoc[`m&lowbar;url`] 
| 
