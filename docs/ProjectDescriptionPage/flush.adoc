...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/ProjectDescriptionPage.h#L28[ui&sol;widgets&sol;ProjectDescriptionPage&period;h]&gt;`
