...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/update/LibrariesTask.h#L6[minecraft&sol;update&sol;LibrariesTask&period;h]&gt;`
