...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/auth/steps/XboxUserStep.h#L9[minecraft&sol;auth&sol;steps&sol;XboxUserStep&period;h]&gt;`
