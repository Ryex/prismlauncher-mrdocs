...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/modrinth/ModrinthPackExportTask.h#L29[modplatform&sol;modrinth&sol;ModrinthPackExportTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ModrinthPackExportTask
...
| xref:ModrinthPackExportTask/2constructor.adoc[`ModrinthPackExportTask`]         [.small]#[constructor]#
| 
...
| xref:ModrinthPackExportTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:ModrinthPackExportTask/abort.adoc[`abort`] 
| 
