...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/modrinth/ModrinthPackExportTask.h#L29[modplatform&sol;modrinth&sol;ModrinthPackExportTask&period;h]&gt;`
