...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/ResourceFolderModel.h#L64[minecraft&sol;mod&sol;ResourceFolderModel&period;h]&gt;`
