...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/flame/FlameInstanceCreationTask.h#L54[modplatform&sol;flame&sol;FlameInstanceCreationTask&period;h]&gt;`
