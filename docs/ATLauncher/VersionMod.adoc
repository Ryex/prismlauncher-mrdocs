...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/atlauncher/ATLPackManifest.h#L90[modplatform&sol;atlauncher&sol;ATLPackManifest&period;h]&gt;`
