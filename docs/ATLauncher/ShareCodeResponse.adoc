...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/atlauncher/ATLShareCode.h#L38[modplatform&sol;atlauncher&sol;ATLShareCode&period;h]&gt;`
