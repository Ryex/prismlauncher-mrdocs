...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/atlauncher/ATLPackInstallTask.h#L81[modplatform&sol;atlauncher&sol;ATLPackInstallTask&period;h]&gt;`
