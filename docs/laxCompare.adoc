...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/tasks/GetModDependenciesTask.cpp#L310[minecraft&sol;mod&sol;tasks&sol;GetModDependenciesTask&period;cpp]&gt;`
