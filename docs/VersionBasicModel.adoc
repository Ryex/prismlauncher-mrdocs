...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/ModFilterWidget.cpp#L57[ui&sol;widgets&sol;ModFilterWidget&period;cpp]&gt;`
