...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/ResourcePackFolderModel.h#L12[minecraft&sol;mod&sol;ResourcePackFolderModel&period;h]&gt;`
