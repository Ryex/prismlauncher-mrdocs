...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/InstanceList.cpp#L861[InstanceList&period;cpp]&gt;`
...
| xref:InstanceStaging/2constructor.adoc[`InstanceStaging`]         [.small]#[constructor]#
| 
...
| xref:InstanceStaging/2destructor.adoc[`&tilde;InstanceStaging`] [.small]#[destructor]#
| 
...
| xref:InstanceStaging/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:InstanceStaging/warnings.adoc[`warnings`] 
| 
