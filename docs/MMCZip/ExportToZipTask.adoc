...
= xref:MMCZip.adoc[MMCZip]::ExportToZipTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/MMCZip.h#L155[MMCZip&period;h]&gt;`
...
| xref:MMCZip/ExportToZipTask/2constructor.adoc[`ExportToZipTask`]         [.small]#[constructor]#
| 
...
| xref:MMCZip/ExportToZipTask/addExtraFile.adoc[`addExtraFile`] 
| 
...
| xref:MMCZip/ExportToZipTask/setExcludeFiles.adoc[`setExcludeFiles`] 
| 
...
| xref:MMCZip/ExportToZipTask/2destructor.adoc[`&tilde;ExportToZipTask`] [.small]#[destructor]#
| 
...
| xref:MMCZip/ExportToZipTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:MMCZip/ExportToZipTask/abort.adoc[`abort`] 
| 
...
| xref:MMCZip/ExportToZipTask/exportZip.adoc[`exportZip`] 
| 

| xref:MMCZip/ExportToZipTask/finish.adoc[`finish`] 
| 
