...
= xref:MMCZip.adoc[MMCZip]::ExtractZipTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/MMCZip.h#L210[MMCZip&period;h]&gt;`
...
| xref:MMCZip/ExtractZipTask/2constructor.adoc[`ExtractZipTask`]         [.small]#[constructor]#
| 
...
| xref:MMCZip/ExtractZipTask/2destructor.adoc[`&tilde;ExtractZipTask`] [.small]#[destructor]#
| 
...
| xref:MMCZip/ExtractZipTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:MMCZip/ExtractZipTask/abort.adoc[`abort`] 
| 
...
| xref:MMCZip/ExtractZipTask/extractZip.adoc[`extractZip`] 
| 

| xref:MMCZip/ExtractZipTask/finish.adoc[`finish`] 
| 
