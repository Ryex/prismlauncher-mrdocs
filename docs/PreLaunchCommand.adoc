...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/steps/PreLaunchCommand.h#L21[launch&sol;steps&sol;PreLaunchCommand&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class PreLaunchCommand
...
| xref:PreLaunchCommand/2constructor.adoc[`PreLaunchCommand`]         [.small]#[constructor]#
| 
...
| xref:PreLaunchCommand/executeTask.adoc[`executeTask`] 
| 
...
| xref:PreLaunchCommand/setWorkingDirectory.adoc[`setWorkingDirectory`] 
| 
...
| xref:PreLaunchCommand/2destructor.adoc[`&tilde;PreLaunchCommand`] [.small]#[destructor]#
| 
...
| xref:PreLaunchCommand/staticMetaObject.adoc[`staticMetaObject`] 
| 
