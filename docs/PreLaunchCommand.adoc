...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launch/steps/PreLaunchCommand.h#L21[launch&sol;steps&sol;PreLaunchCommand&period;h]&gt;`
