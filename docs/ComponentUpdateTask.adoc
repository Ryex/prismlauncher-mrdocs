...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/ComponentUpdateTask.h#L11[minecraft&sol;ComponentUpdateTask&period;h]&gt;`
...
| xref:ComponentUpdateTask/Mode.adoc[`Mode`] 
| 
...
| xref:ComponentUpdateTask/2constructor.adoc[`ComponentUpdateTask`]         [.small]#[constructor]#
| 
...
| xref:ComponentUpdateTask/2destructor.adoc[`&tilde;ComponentUpdateTask`] [.small]#[destructor]#
| 
...
| xref:ComponentUpdateTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
