...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/modrinth/ModrinthCheckUpdate.h#L5[modplatform&sol;modrinth&sol;ModrinthCheckUpdate&period;h]&gt;`
