...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/VersionPage.cpp#L77[ui&sol;pages&sol;instance&sol;VersionPage&period;cpp]&gt;`
