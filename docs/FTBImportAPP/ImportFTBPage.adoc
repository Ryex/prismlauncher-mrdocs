...
= xref:FTBImportAPP.adoc[FTBImportAPP]::ImportFTBPage
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/modplatform/import_ftb/ImportFTBPage.h#L38[ui&sol;pages&sol;modplatform&sol;import&lowbar;ftb&sol;ImportFTBPage&period;h]&gt;`
...
| xref:FTBImportAPP/ImportFTBPage/2constructor.adoc[`ImportFTBPage`]         [.small]#[constructor]#
| 
...
| 
| xref:FTBImportAPP/ImportFTBPage/metaObject.adoc[`metaObject`] 
| 
...
| 
| xref:FTBImportAPP/ImportFTBPage/qt_metacall.adoc[`qt&lowbar;metacall`] 
| 

| xref:FTBImportAPP/ImportFTBPage/qt_metacast.adoc[`qt&lowbar;metacast`] 
| 
...
| 
| xref:FTBImportAPP/ImportFTBPage/2destructor.adoc[`&tilde;ImportFTBPage`] [.small]#[destructor]#
| 
...
| xref:FTBImportAPP/ImportFTBPage/tr.adoc[`tr`] 
| 
...
| xref:FTBImportAPP/ImportFTBPage/staticMetaObject.adoc[`staticMetaObject`] 
| 
