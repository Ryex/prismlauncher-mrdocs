...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/import_ftb/PackInstallTask.h#L29[modplatform&sol;import&lowbar;ftb&sol;PackInstallTask&period;h]&gt;`
