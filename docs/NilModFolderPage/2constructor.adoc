...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ModFolderPage.h#L92[ui&sol;pages&sol;instance&sol;ModFolderPage&period;h]&gt;`
