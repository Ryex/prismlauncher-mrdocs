...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/UpdateAvailableDialog.h#L30[ui&sol;dialogs&sol;UpdateAvailableDialog&period;h]&gt;`
