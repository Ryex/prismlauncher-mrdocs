...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/screenshots/ImgurAlbumCreation.h#L41[screenshots&sol;ImgurAlbumCreation&period;h]&gt;`
...
| xref:ImgurAlbumCreation/Result.adoc[`Result`] 
| 

| xref:ImgurAlbumCreation/Sink.adoc[`Sink`] 
| 
...
| xref:ImgurAlbumCreation/getReply.adoc[`getReply`] 
| 
...
| xref:ImgurAlbumCreation/2destructor.adoc[`&tilde;ImgurAlbumCreation`] [.small]#[destructor]#
| 
...
| xref:ImgurAlbumCreation/make.adoc[`make`] 
| 
