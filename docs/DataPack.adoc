...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/mod/DataPack.h#L35[minecraft&sol;mod&sol;DataPack&period;h]&gt;`
...
| xref:DataPack/2constructor.adoc[`DataPack`]         [.small]#[constructor]#
| 
