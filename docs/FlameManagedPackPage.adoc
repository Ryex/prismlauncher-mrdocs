...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ManagedPackPage.h#L139[ui&sol;pages&sol;instance&sol;ManagedPackPage&period;h]&gt;`
