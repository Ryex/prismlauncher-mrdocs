...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/flame/FlameCheckUpdate.h#L5[modplatform&sol;flame&sol;FlameCheckUpdate&period;h]&gt;`
