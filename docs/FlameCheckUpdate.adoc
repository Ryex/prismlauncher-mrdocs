...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/flame/FlameCheckUpdate.h#L5[modplatform&sol;flame&sol;FlameCheckUpdate&period;h]&gt;`
...
| xref:FlameCheckUpdate/2constructor.adoc[`FlameCheckUpdate`]         [.small]#[constructor]#
| 
...
| xref:FlameCheckUpdate/staticMetaObject.adoc[`staticMetaObject`] 
| 
