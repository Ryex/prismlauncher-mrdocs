...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/technic/TechnicPackProcessor.h#L23[modplatform&sol;technic&sol;TechnicPackProcessor&period;h]&gt;`
