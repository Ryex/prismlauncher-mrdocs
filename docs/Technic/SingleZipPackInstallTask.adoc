...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/technic/SingleZipPackInstallTask.h#L31[modplatform&sol;technic&sol;SingleZipPackInstallTask&period;h]&gt;`
