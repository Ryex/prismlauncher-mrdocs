...
= xref:Technic.adoc[Technic]::SingleZipPackInstallTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/technic/SingleZipPackInstallTask.h#L31[modplatform&sol;technic&sol;SingleZipPackInstallTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class SingleZipPackInstallTask
...
| xref:Technic/SingleZipPackInstallTask/2constructor.adoc[`SingleZipPackInstallTask`]         [.small]#[constructor]#
| 
...
| xref:Technic/SingleZipPackInstallTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
