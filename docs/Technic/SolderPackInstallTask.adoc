...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/technic/SolderPackInstallTask.h#L46[modplatform&sol;technic&sol;SolderPackInstallTask&period;h]&gt;`
