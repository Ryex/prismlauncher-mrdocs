...
= xref:Technic.adoc[Technic]::SolderPackInstallTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/technic/SolderPackInstallTask.h#L46[modplatform&sol;technic&sol;SolderPackInstallTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class SolderPackInstallTask
...
| xref:Technic/SolderPackInstallTask/2constructor.adoc[`SolderPackInstallTask`]         [.small]#[constructor]#
| 
...
| xref:Technic/SolderPackInstallTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
