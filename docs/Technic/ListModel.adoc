...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/modplatform/technic/TechnicModel.h#L47[ui&sol;pages&sol;modplatform&sol;technic&sol;TechnicModel&period;h]&gt;`
