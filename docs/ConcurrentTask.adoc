...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/tasks/ConcurrentTask.h#L50[tasks&sol;ConcurrentTask&period;h]&gt;`
...
| xref:ConcurrentTask/2constructor.adoc[`ConcurrentTask`]         [.small]#[constructor]#
| 
...
| xref:ConcurrentTask/2destructor.adoc[`&tilde;ConcurrentTask`] [.small]#[destructor]#
| 
