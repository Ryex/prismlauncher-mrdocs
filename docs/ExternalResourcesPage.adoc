...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/ExternalResourcesPage.h#L19[ui&sol;pages&sol;instance&sol;ExternalResourcesPage&period;h]&gt;`
...
| xref:ExternalResourcesPage/2constructor.adoc[`ExternalResourcesPage`]         [.small]#[constructor]#
| 
...
| xref:ExternalResourcesPage/2destructor.adoc[`&tilde;ExternalResourcesPage`] [.small]#[destructor]#
| 
