...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ExternalResourcesPage.h#L19[ui&sol;pages&sol;instance&sol;ExternalResourcesPage&period;h]&gt;`
