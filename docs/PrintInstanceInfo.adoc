...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/PrintInstanceInfo.h#L23[minecraft&sol;launch&sol;PrintInstanceInfo&period;h]&gt;`
