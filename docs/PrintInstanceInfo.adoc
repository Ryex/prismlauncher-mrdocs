...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/PrintInstanceInfo.h#L23[minecraft&sol;launch&sol;PrintInstanceInfo&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class PrintInstanceInfo
...
| xref:PrintInstanceInfo/2constructor.adoc[`PrintInstanceInfo`]         [.small]#[constructor]#
| 
...
| xref:PrintInstanceInfo/executeTask.adoc[`executeTask`] 
| 
...
| xref:PrintInstanceInfo/2destructor.adoc[`&tilde;PrintInstanceInfo`] [.small]#[destructor]#
| 
...
| xref:PrintInstanceInfo/staticMetaObject.adoc[`staticMetaObject`] 
| 
