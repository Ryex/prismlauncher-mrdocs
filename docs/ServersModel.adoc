...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/ServersPage.cpp#L156[ui&sol;pages&sol;instance&sol;ServersPage&period;cpp]&gt;`
