...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/InstanceCopyTask.h#L14[InstanceCopyTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class InstanceCopyTask
...
| xref:InstanceCopyTask/2constructor.adoc[`InstanceCopyTask`]         [.small]#[constructor]#
| 
...
| xref:InstanceCopyTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:InstanceCopyTask/abort.adoc[`abort`] 
| 

| xref:InstanceCopyTask/copyAborted.adoc[`copyAborted`] 
| 

| xref:InstanceCopyTask/copyFinished.adoc[`copyFinished`] 
| 
