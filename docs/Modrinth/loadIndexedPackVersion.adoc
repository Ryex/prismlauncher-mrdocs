...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/modrinth/ModrinthPackIndex.h#L29[modplatform&sol;modrinth&sol;ModrinthPackIndex&period;h]&gt;`
