...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/modrinth/ModrinthPackManifest.h#L84[modplatform&sol;modrinth&sol;ModrinthPackManifest&period;h]&gt;`
