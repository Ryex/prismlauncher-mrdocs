...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/MojangVersionFormat.cpp#L72[minecraft&sol;MojangVersionFormat&period;cpp]&gt;`
