...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/instanceview/AccessibleInstanceView_p.h#L71[ui&sol;instanceview&sol;AccessibleInstanceView&lowbar;p&period;h]&gt;`
