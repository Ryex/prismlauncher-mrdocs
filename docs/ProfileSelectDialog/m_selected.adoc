...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/ProfileSelectDialog.h#L82[ui&sol;dialogs&sol;ProfileSelectDialog&period;h]&gt;`
