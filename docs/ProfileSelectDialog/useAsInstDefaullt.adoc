...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/ProfileSelectDialog.h#L71[ui&sol;dialogs&sol;ProfileSelectDialog&period;h]&gt;`
