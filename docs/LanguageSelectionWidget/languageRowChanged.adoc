...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/LanguageSelectionWidget.h#L36[ui&sol;widgets&sol;LanguageSelectionWidget&period;h]&gt;`
