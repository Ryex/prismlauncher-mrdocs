...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/NewComponentDialog.h#L31[ui&sol;dialogs&sol;NewComponentDialog&period;h]&gt;`
