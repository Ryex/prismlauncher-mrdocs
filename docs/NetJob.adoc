...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/net/NetJob.h#L49[net&sol;NetJob&period;h]&gt;`
...
| xref:NetJob/2constructor.adoc[`NetJob`]         [.small]#[constructor]#
| 
...
| xref:NetJob/addNetAction.adoc[`addNetAction`] 
| 
...
| xref:NetJob/emitFailed.adoc[`emitFailed`] 
| 
...
| xref:NetJob/getFailedActions.adoc[`getFailedActions`] 
| 

| xref:NetJob/getFailedFiles.adoc[`getFailedFiles`] 
| 
...
| xref:NetJob/setAskRetry.adoc[`setAskRetry`] 
| 
...
| xref:NetJob/2destructor.adoc[`&tilde;NetJob`] [.small]#[destructor]#
| 
...
| xref:NetJob/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:NetJob/isOnline.adoc[`isOnline`] 
| 
