...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/VariableSizedImageObject.h#L32[ui&sol;widgets&sol;VariableSizedImageObject&period;h]&gt;`
