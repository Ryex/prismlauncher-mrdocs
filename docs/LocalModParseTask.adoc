...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/mod/tasks/LocalModParseTask.h#L33[minecraft&sol;mod&sol;tasks&sol;LocalModParseTask&period;h]&gt;`
