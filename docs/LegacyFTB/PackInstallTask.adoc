...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/legacy_ftb/PackInstallTask.h#L17[modplatform&sol;legacy&lowbar;ftb&sol;PackInstallTask&period;h]&gt;`
