...
= xref:LegacyFTB.adoc[LegacyFTB]::PackInstallTask
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/legacy_ftb/PackInstallTask.h#L17[modplatform&sol;legacy&lowbar;ftb&sol;PackInstallTask&period;h]&gt;`
...
| xref:LegacyFTB/PackInstallTask/2constructor.adoc[`PackInstallTask`]         [.small]#[constructor]#
| 
...
| xref:LegacyFTB/PackInstallTask/2destructor.adoc[`&tilde;PackInstallTask`] [.small]#[destructor]#
| 
...
| xref:LegacyFTB/PackInstallTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
