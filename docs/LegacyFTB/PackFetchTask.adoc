...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/legacy_ftb/PackFetchTask.h#L12[modplatform&sol;legacy&lowbar;ftb&sol;PackFetchTask&period;h]&gt;`
