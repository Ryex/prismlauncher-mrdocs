...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/widgets/ThemeCustomizationWidget.h#L29[ui&sol;widgets&sol;ThemeCustomizationWidget&period;h]&gt;`
