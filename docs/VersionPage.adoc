...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/instance/VersionPage.h#L54[ui&sol;pages&sol;instance&sol;VersionPage&period;h]&gt;`
