...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/java/JavaInstallList.h#L61[java&sol;JavaInstallList&period;h]&gt;`
...
| xref:JavaListLoadTask/2constructor.adoc[`JavaListLoadTask`]         [.small]#[constructor]#
| 
...
| xref:JavaListLoadTask/javaCheckerFinished.adoc[`javaCheckerFinished`] 
| 
...
| xref:JavaListLoadTask/2destructor.adoc[`&tilde;JavaListLoadTask`] [.small]#[destructor]#
| 
...
| xref:JavaListLoadTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
...
| xref:JavaListLoadTask/m_current_recommended.adoc[`m&lowbar;current&lowbar;recommended`] 
| 
...
| xref:JavaListLoadTask/m_job.adoc[`m&lowbar;job`] 
| 

| xref:JavaListLoadTask/m_list.adoc[`m&lowbar;list`] 
| 

| xref:JavaListLoadTask/m_only_managed_versions.adoc[`m&lowbar;only&lowbar;managed&lowbar;versions`] 
| 
...
| xref:JavaListLoadTask/m_results.adoc[`m&lowbar;results`] 
| 
