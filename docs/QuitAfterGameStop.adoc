...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launch/steps/QuitAfterGameStop.h#L23[launch&sol;steps&sol;QuitAfterGameStop&period;h]&gt;`
