...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/steps/QuitAfterGameStop.h#L23[launch&sol;steps&sol;QuitAfterGameStop&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class QuitAfterGameStop
...
| xref:QuitAfterGameStop/2constructor.adoc[`QuitAfterGameStop`]         [.small]#[constructor]#
| 
...
| xref:QuitAfterGameStop/executeTask.adoc[`executeTask`] 
| 
...
| xref:QuitAfterGameStop/2destructor.adoc[`&tilde;QuitAfterGameStop`] [.small]#[destructor]#
| 
...
| xref:QuitAfterGameStop/staticMetaObject.adoc[`staticMetaObject`] 
| 
