...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/TexturePackPage.h#L45[ui&sol;pages&sol;instance&sol;TexturePackPage&period;h]&gt;`
