...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/translations/TranslationsModel.cpp#L61[translations&sol;TranslationsModel&period;cpp]&gt;`
