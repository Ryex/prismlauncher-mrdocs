...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/pages/global/LauncherPage.h#L53[ui&sol;pages&sol;global&sol;LauncherPage&period;h]&gt;`
