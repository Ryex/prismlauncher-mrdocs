...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/UpdateAvailableDialog.h#L40[ui&sol;dialogs&sol;UpdateAvailableDialog&period;h]&gt;`
