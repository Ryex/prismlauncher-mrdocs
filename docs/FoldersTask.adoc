...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/update/FoldersTask.h#L6[minecraft&sol;update&sol;FoldersTask&period;h]&gt;`
...
| xref:FoldersTask/2constructor.adoc[`FoldersTask`]         [.small]#[constructor]#
| 
...
| xref:FoldersTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:FoldersTask/2destructor.adoc[`&tilde;FoldersTask`] [.small]#[destructor]#
| 
...
| xref:FoldersTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
