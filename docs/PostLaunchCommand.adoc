...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launch/steps/PostLaunchCommand.h#L21[launch&sol;steps&sol;PostLaunchCommand&period;h]&gt;`
