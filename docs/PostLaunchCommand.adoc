...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/steps/PostLaunchCommand.h#L21[launch&sol;steps&sol;PostLaunchCommand&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class PostLaunchCommand
...
| xref:PostLaunchCommand/2constructor.adoc[`PostLaunchCommand`]         [.small]#[constructor]#
| 
...
| xref:PostLaunchCommand/executeTask.adoc[`executeTask`] 
| 
...
| xref:PostLaunchCommand/setWorkingDirectory.adoc[`setWorkingDirectory`] 
| 
...
| xref:PostLaunchCommand/2destructor.adoc[`&tilde;PostLaunchCommand`] [.small]#[destructor]#
| 
...
| xref:PostLaunchCommand/staticMetaObject.adoc[`staticMetaObject`] 
| 
