...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/auth/steps/XboxAuthorizationStep.h#L9[minecraft&sol;auth&sol;steps&sol;XboxAuthorizationStep&period;h]&gt;`
