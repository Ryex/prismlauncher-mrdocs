...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/technic/SolderPackManifest.h#L35[modplatform&sol;technic&sol;SolderPackManifest&period;h]&gt;`
