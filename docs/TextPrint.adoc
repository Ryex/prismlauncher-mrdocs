...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/steps/TextPrint.h#L26[launch&sol;steps&sol;TextPrint&period;h]&gt;`
...
| xref:TextPrint/2constructor.adoc[`TextPrint`]         [.small]#[constructor]#
| 
...
| xref:TextPrint/executeTask.adoc[`executeTask`] 
| 
...
| xref:TextPrint/2destructor.adoc[`&tilde;TextPrint`] [.small]#[destructor]#
| 
...
| xref:TextPrint/staticMetaObject.adoc[`staticMetaObject`] 
| 
