...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/ExtractNatives.h#L21[minecraft&sol;launch&sol;ExtractNatives&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class ExtractNatives
...
| xref:ExtractNatives/2constructor.adoc[`ExtractNatives`]         [.small]#[constructor]#
| 
...
| xref:ExtractNatives/executeTask.adoc[`executeTask`] 
| 
...
| xref:ExtractNatives/2destructor.adoc[`&tilde;ExtractNatives`] [.small]#[destructor]#
| 
...
| xref:ExtractNatives/staticMetaObject.adoc[`staticMetaObject`] 
| 
