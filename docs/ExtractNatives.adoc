...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/ExtractNatives.h#L21[minecraft&sol;launch&sol;ExtractNatives&period;h]&gt;`
