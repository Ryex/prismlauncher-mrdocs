...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/ui/dialogs/ResourceUpdateDialog.cpp#L399[ui&sol;dialogs&sol;ResourceUpdateDialog&period;cpp]&gt;`
