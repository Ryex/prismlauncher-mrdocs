...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/EnsureMetadataTask.h#L14[modplatform&sol;EnsureMetadataTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class EnsureMetadataTask
...
| xref:EnsureMetadataTask/2constructor.adoc[`EnsureMetadataTask`]         [.small]#[constructor]#
| 
...
| xref:EnsureMetadataTask/getHashingTask.adoc[`getHashingTask`] 
| 
...
| 
| xref:EnsureMetadataTask/metadataFailed.adoc[`metadataFailed`] 
| 

| xref:EnsureMetadataTask/metadataReady.adoc[`metadataReady`] 
| 
...
| xref:EnsureMetadataTask/2destructor.adoc[`&tilde;EnsureMetadataTask`] [.small]#[destructor]#
| 
...
| xref:EnsureMetadataTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
