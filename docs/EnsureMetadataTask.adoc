...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/EnsureMetadataTask.h#L14[modplatform&sol;EnsureMetadataTask&period;h]&gt;`
