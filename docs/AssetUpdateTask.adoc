...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/update/AssetUpdateTask.h#L6[minecraft&sol;update&sol;AssetUpdateTask&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class AssetUpdateTask
...
| xref:AssetUpdateTask/2constructor.adoc[`AssetUpdateTask`]         [.small]#[constructor]#
| 
...
| xref:AssetUpdateTask/executeTask.adoc[`executeTask`] 
| 
...
| xref:AssetUpdateTask/2destructor.adoc[`&tilde;AssetUpdateTask`] [.small]#[destructor]#
| 
...
| xref:AssetUpdateTask/staticMetaObject.adoc[`staticMetaObject`] 
| 
