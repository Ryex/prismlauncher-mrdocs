...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/update/AssetUpdateTask.h#L6[minecraft&sol;update&sol;AssetUpdateTask&period;h]&gt;`
