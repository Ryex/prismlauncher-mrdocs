...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/ShaderPackPage.h#L42[ui&sol;pages&sol;instance&sol;ShaderPackPage&period;h]&gt;`
