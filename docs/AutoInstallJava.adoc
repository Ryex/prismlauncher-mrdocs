...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/launch/AutoInstallJava.h#L44[minecraft&sol;launch&sol;AutoInstallJava&period;h]&gt;`
