...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/minecraft/launch/LauncherPartLaunch.h#L24[minecraft&sol;launch&sol;LauncherPartLaunch&period;h]&gt;`
