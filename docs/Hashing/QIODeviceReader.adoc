...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/helpers/HashUtils.cpp#L31[modplatform&sol;helpers&sol;HashUtils&period;cpp]&gt;`
