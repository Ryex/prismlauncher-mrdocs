...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/helpers/HashUtils.h#L21[modplatform&sol;helpers&sol;HashUtils&period;h]&gt;`
