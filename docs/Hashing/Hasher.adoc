[#Hashing-Hasher]
= xref:Hashing.adoc[Hashing]::Hasher
:relfileprefix: ../
:mrdocs:
...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/helpers/HashUtils.h#L21[modplatform&sol;helpers&sol;HashUtils&period;h]&gt;`
...
| xref:Hashing/Hasher/Ptr.adoc[`Ptr`] 
| 
...
| xref:Hashing/Hasher/2constructor.adoc[`Hasher`]         [.small]#[constructor]#
| 
...
| xref:Hashing/Hasher/executeTask.adoc[`executeTask`] 
| 
...
| xref:Hashing/Hasher/getPath.adoc[`getPath`] 
| 

| xref:Task/getProgress.adoc[`getProgress`] 
| 

| xref:Hashing/Hasher/getResult.adoc[`getResult`] 
| 
...
| 
| xref:Hashing/Hasher/resultsReady.adoc[`resultsReady`] 
| 
...
| xref:Hashing/Hasher/staticMetaObject.adoc[`staticMetaObject`] 
| 
