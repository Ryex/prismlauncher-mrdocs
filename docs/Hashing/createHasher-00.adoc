...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/modplatform/helpers/HashUtils.h#L48[modplatform&sol;helpers&sol;HashUtils&period;h]&gt;`
