...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/ui/pages/instance/ModFolderPage.h#L75[ui&sol;pages&sol;instance&sol;ModFolderPage&period;h]&gt;`
