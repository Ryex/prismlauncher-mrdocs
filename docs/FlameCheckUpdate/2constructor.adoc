...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/modplatform/flame/FlameCheckUpdate.h#L9[modplatform&sol;flame&sol;FlameCheckUpdate&period;h]&gt;`
