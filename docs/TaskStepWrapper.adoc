...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/launch/TaskStepWrapper.h#L24[launch&sol;TaskStepWrapper&period;h]&gt;`

[source,cpp,subs="verbatim,replacements,macros,-callouts"]
----
class TaskStepWrapper
...
| xref:TaskStepWrapper/2constructor.adoc[`TaskStepWrapper`]         [.small]#[constructor]#
| 
...
| xref:TaskStepWrapper/executeTask.adoc[`executeTask`] 
| 
...
| xref:TaskStepWrapper/2destructor.adoc[`&tilde;TaskStepWrapper`] [.small]#[destructor]#
| 
...
| xref:TaskStepWrapper/staticMetaObject.adoc[`staticMetaObject`] 
| 
