...
Declared in `&lt;https://github.com/PrismLauncher/PrismLauncher/blob/develop/launcher/minecraft/mod/TexturePackFolderModel.h#L43[minecraft&sol;mod&sol;TexturePackFolderModel&period;h]&gt;`
...
| xref:TexturePackFolderModel/Columns.adoc[`Columns`] 
| 
...
| xref:TexturePackFolderModel/2constructor.adoc[`TexturePackFolderModel`]         [.small]#[constructor]#
| 

| xref:ResourceFolderModel/allResources.adoc[`allResources`] 
| 

| xref:TexturePackFolderModel/allTexturePacks.adoc[`allTexturePacks`] 
| 
...
| xref:TexturePackFolderModel/createParseTask.adoc[`createParseTask`] 
| 

| xref:TexturePackFolderModel/createResource.adoc[`createResource`] 
| 
...
| xref:TexturePackFolderModel/selectedTexturePacks.adoc[`selectedTexturePacks`] 
| 
...
| xref:TexturePackFolderModel/staticMetaObject.adoc[`staticMetaObject`] 
| 
